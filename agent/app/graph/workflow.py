...
from app.graph.nodes.notification_node import notify_teams_node
workflow = StateGraph(AgentState)

workflow.add_node("parse_log", parse_log_node)
workflow.add_node("classify_rca", classify_rca_node)
workflow.add_node("notify_teams", notify_teams_node)

workflow.set_entry_point("parse_log")
workflow.add_edge("parse_log", "classify_rca")
workflow.add_edge("classify_rca", "notify_teams")
workflow.add_edge("notify_teams", END)
